...
int main()
{
  ...
  printf("Digite o PIB sa cidade: R$");
  scanf(" %f", &pib[0]);
  ...
  printf("Digite o PIB ca cidade: R$");
  scanf(" %f", &pib[1]);
  ...
  printf("\n\n---------\nCARTA UM\n---------\n");
  printf("Estado: %s\nCodigo: %s\nCidade: %s\nPopulação: %d\nPontos turísticos: %i\nÁrea: %.2fKm²\nPIB: R$%.2f",estado[0], codigo[0], cidade[0], populacao[0], pontos[0], area[0], pib[0]);

  printf("\n\n---------\nCARTA DOIS\n---------\n");
  printf("Estado: %s\nCodigo: %s\nCidade: %s\nPopulação: %d\nPontos turísticos: %i\nÁrea: %.2fKm²\nPIB: R$%.2f",estado[1], codigo[1], cidade[1], populacao[1], pontos[1], area[1], pib[1]);
